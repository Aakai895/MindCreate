...
export default function Chatscreen(props) {
  ...
  <View style={styles.cardIMG}>
      <Text style={styles.cardTexto}>FOTOS DO PRODUTO <Text style={{color: 'red'}}>*</Text></Text>
  ...
  <View style={styles.card}>
    <View style={styles.header}>
      <Text style={styles.cardTexto}>NOME DO PRODUTO <Text style={styles.asterisco}>*</Text></Text>
  ...
  <View style={styles.cardD}>
    <View style={styles.header}>
      <Text style={styles.cardTexto}>DESCRIÇÃO <Text style={styles.asterisco}>*</Text></Text>
  ...
  <View style={styles.card}>
    <View style={styles.titulocardP}>
      <Ionicons
            ...
            color={''}
          />
      <Text style={styles.cardTexto}>PREÇO <Text style={styles.asterisco}>*</Text></Text>
    </View>
    <TextInput style={styles.cardTextoI} maxLength={6} placeholder={'Definir'}/>
  </View>
  <View style={styles.card}>
    <Text style={styles.cardTexto}>CATEGORIA <Text style={styles.asterisco}>*</Text></Text>
